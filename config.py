...
OWNER_ID = int(getenv("OWNER_ID", 5101317729))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Alfabots_support")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Alfabots_update")
